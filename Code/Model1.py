...
def main():
    ...
    checkpoint_path = 'C:\\Users\\grifk\\OneDrive\\Documents\\SchoolStuff\\CS5821\\SemesterProject\\Code\\CheckPoints\\Model1'
    ...
    model.save('Model1Save')
    model_json = model.to_json()
    with open("Model1Save.json", "w") as json_file:
    ...
    plt.title('Training and Validation Accuracy of Model1 Model')

    plt.subplot(1, 2, 2)
    plt.plot(epochs_range, loss, label='Training Loss')
    plt.plot(epochs_range, val_loss, label='Validation Loss')
    plt.legend(loc='upper right')
    plt.title('Training and Validation Loss of Model1 Model')
    plt.show()
