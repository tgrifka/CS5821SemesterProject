...
def main():
    ...
    checkpoint_path = 'C:\\Users\\grifk\\OneDrive\\Documents\\SchoolStuff\\CS5821\\SemesterProject\\Code\\CheckPoints\\FinalModel3'
    ...
    model.save('FinalModel3Save')
    model_json = model.to_json()
    with open("FinalModel3Save.json", "w") as json_file:
    ...
    plt.title('Train and Val Accuracy of Final Model')

    plt.subplot(1, 2, 2)
    plt.plot(epochs_range, loss, label='Training Loss')
    plt.plot(epochs_range, val_loss, label='Validation Loss')
    plt.legend(loc='upper right')
    plt.title('Train and Val Loss of Final Model')
    plt.show()
