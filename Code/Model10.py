...
def main():
    ...
    checkpoint_path = 'C:\\Users\\grifk\\OneDrive\\Documents\\SchoolStuff\\CS5821\\SemesterProject\\Code\\CheckPoints\\Model10'
    ...
    model.save('Model10Save')
    model_json = model.to_json()
    with open("Model10Save.json", "w") as json_file:
    ...
    plt.title('Train and Val Accuracy of Model10')

    plt.subplot(1, 2, 2)
    plt.plot(epochs_range, loss, label='Training Loss')
    plt.plot(epochs_range, val_loss, label='Validation Loss')
    plt.legend(loc='upper right')
    plt.title('Train and Val Loss of Model10')
    plt.show()
