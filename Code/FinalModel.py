...
def main():
    ...
    checkpoint_path = 'C:\\Users\\grifk\\OneDrive\\Documents\\SchoolStuff\\CS5821\\SemesterProject\\Code\\CheckPoints\\FinalModel'
    ...
    model.save('FinalModelSave')
    model_json = model.to_json()
    with open("FinalModelSave.json", "w") as json_file:
